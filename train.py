...
parser.add_argument("--model_names", default=['FLINet'], type=list, help="'ACM', 'ALCNet', 'DNANet', 'ISNet', 'UIUNet', 'RDIAN', 'RISTDnet'")
...
parser.add_argument("--log_dir", type=str, default="./otherlogs/FLINet", help='path of log files')
...
class Net(nn.Module):
    def __init__(self, model_name, mode):
        ...
        if model_name == 'FLINet':
            if mode == 'train':
                self.model = FLINet(mode='train')
            else:
                self.model = FLINet(mode='test')
